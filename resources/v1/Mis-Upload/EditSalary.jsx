                                ...
                                <div className="row">
                                    <div className="col-sm-6">
                                        <ol className="breadcrumb mt-2">
                                            <li className="breadcrumb-item"><a href="/app/mis-upload-app/mis-salary/list">Payments</a></li>
                                            <li className="breadcrumb-item active">Payments Details</li>
                                        </ol>
                                    </div>
                                    <div className="col-md-6  text-right mt-4">

                                        <a href="/app/mis-upload-app/mis-salary/list" className="btn btn-primary btn-sm"><i className="fa fa-angle-left" aria-hidden="true"></i> Back</a>
                                    </div>
                                </div>
                            </div>
