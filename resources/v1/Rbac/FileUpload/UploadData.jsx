...
const UploadData = (props) => {
    ...
    const breadCrumbs = [
        ...
        { name: "Upload Datas", url: "#", class: "breadcrumb-item active" }
    ];
                                    ...
                                    <div className="page-title-box">
                                        <div className="row align-items-center">
                                            <div className="col-sm-6">
                                                <h4 className="page-title mt-1 width-auto">Upload Data</h4>
                                            </div>
                                        </div>
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <BreadCrumb breadCrumbs={breadCrumbs}
                                                    backButton={{ url: '/app/access-app/fileupload/list', label: 'Back' }}> </BreadCrumb>
                                                ...
                                                <div className="card-body table-card">
                                                    <div className="row">
                                                        <div className="col-md-6">
                                                            <h4 className="mt-0 header-title  pl-3">Upload Data </h4>
                                                        </div>
                                                    </div>
