        ...
        const postData = paymentDetails;
         ...
         axios.post(UPDATE_XL_DATA, postData).then((res) => {
           ...
           if(res.data.success=== true){
            ...
            return props.history.push('/app/reports-app/ops-salary/list');
                                ...
                                <div className="row">
                                    <div className="col-sm-6">
                                        <ol className="breadcrumb mt-2">
                                            <li className="breadcrumb-item"><a href="/app/reports-app/ops-salary/list">Payments</a></li>
                                            <li className="breadcrumb-item active">Payments Details</li>
                                        </ol>
                                    </div>
                                    <div className="col-md-6  text-right mt-4">

                                        <a href="/app/reports-app/ops-salary/list" className="btn btn-primary btn-sm"><i className="fa fa-angle-left" aria-hidden="true"></i> Back</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6 col-lg-2">
                                            <div className="form-group">
                                                ...
                                                <span className="d-block mt-1 font-weight-600">{paymentDetails.clientDetail ? paymentDetails.clientDetail.client_name : ''}</span>
                                            </div>
                                        </div>
                                        <div className="col-md-6 col-lg-2">
                                            <div className="form-group">
                                                <label className="font-weight-normal viewlabel">Hub Location</label>
                                                <span className="d-block mt-1 font-weight-600">{paymentDetails.clientDetail ? paymentDetails.clientDetail.hub_name :  ''}</span>
                                            </div>
                                        </div>
                                        <div className="col-md-6 col-lg-2">
                                            <div className="form-group">
                                                <label className="font-weight-normal viewlabel">City </label>
                                                <span className="d-block mt-1 font-weight-600">{paymentDetails.clientDetail ? paymentDetails.clientDetail.city : ''}</span>
                                            </div>
                                        </div>
                                        <div className="col-md-6 col-lg-2">
                                            <div className="form-group">
                                                <label className="font-weight-normal viewlabel">State</label>
                                                <span className="d-block mt-1 font-weight-600">{paymentDetails.clientDetail ? paymentDetails.clientDetail.state :''}</span>
                                            </div>
                                        </div>
                                        <div className="col-md-6 col-lg-2">
                                            <div className="form-group">
